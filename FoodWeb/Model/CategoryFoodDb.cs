...
{
    public class CategoryFoodDb:BasicFoodDb

    {
        public CategoryFoodDb() : base()
        { }
        /// <summary>
        ...
        public List<CategoryFood> GetCategories(ref string err)
        {
        ...
        /// <returns></returns>
        public CategoryFood GetCategoryByID(ref string err, int ID)
        {
            CategoryFood category = null; //Khởi tạo đối tượng category, 
        ...
        public bool InsertCategory(ref string err, ref int rows, CategoryFood category)
        {
        ...
        /// <param name="category">Đối tượng Category</param>
        /// <returns>Thực hiện thành công trả về : true; ngược lại trả về false</returns>
        public bool UpdateCategory(ref string err, ref int rows, CategoryFood category)
        {
        ...
        /// <param name="category">Đối tượng Category</param>
        /// <returns></returns>
        public bool DeleteCategoryByID(ref string err, ref int rows, CategoryFood category)
        {
            SqlParameter[] param = new SqlParameter[]{
                new SqlParameter("@ID",category.ID)
            };
